...
class Dom {
  nthParent(element, len) {
    ...
    let el = typeof element === 'object' ? element : document.querySelector(element);
...
/* harmony import */ var _css_main_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../css/main.scss */ "./assets/css/main.scss");
...
/* harmony import */ var _Ajax__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Ajax */ "./assets/js/Ajax.js");
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dom */ "./assets/js/dom.js");
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./url */ "./assets/js/url.js");
/**
...
__webpack_require__(/*! ./hammerJquery */ "./assets/js/hammerJquery.js");




let dom = new _dom__WEBPACK_IMPORTED_MODULE_4__["Dom"]();
dom.jkscroll(200); // setting up host;

let url;
let bool = location.href.search('localhost') > -1;

if (bool) {
  url = new _url__WEBPACK_IMPORTED_MODULE_5__["Url"]('mnemonicWords/index.php');
} else {
  url = new _url__WEBPACK_IMPORTED_MODULE_5__["Url"]('learnwords/index.php');
}
...
global.david = function () {
  ...
  let octopus = function (v) {
    ...
    function showEditWordModal(e) {
      ...
      let ajax = new _Ajax__WEBPACK_IMPORTED_MODULE_3__["Ajax"]({
        url: path
      });
      ajax.ok.then(data => {
    ...
    return {
      dom,
      Ajax: _Ajax__WEBPACK_IMPORTED_MODULE_3__["Ajax"]
    };
  }(view);
